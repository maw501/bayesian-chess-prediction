...
* [`3.machine_learning_baseline.ipynb`](notebooks/3.machine_learning_baseline.ipynb) [WIP]: step back and fit another machine learning model to provide a benchmark for performance.
